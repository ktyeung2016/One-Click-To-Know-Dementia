...
public class game3demo extends Fragment {
	View v;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		getActivity().getTheme().applyStyle(new Preferences(getActivity()).getFontStyle().getResId(), true);
		v = inflater.inflate(R.layout.game3demo, container, false);
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(Global.s.getgame3status()!=-1){
					...
					Global.onAirAct.pushFragmentBackTo(Pages.Game_three_1);
				}else{
		...
		s=getResources().getStringArray(R.array.game3tipsarray);
		...
		laststep.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v1) {
				...
				if(Stage<4){
					RelativeLayout ans3=(RelativeLayout) v.findViewById(R.id.ans3);
            ...
            public void run() {
                ...
                if (null != overlay && null != overlayImage &&  Stage >= 0 && Stage < s.length) {
                    ...
                    switch (Stage){
                        ...
                        case 1:{
                            View ansContainer = v.findViewById(R.id.ansContainer);
                            if(null != ansContainer && ansContainer.getGlobalVisibleRect(r)){
                                Global.maskOverlay.drawMask(result, r);
                            }
                            break;
                        }
