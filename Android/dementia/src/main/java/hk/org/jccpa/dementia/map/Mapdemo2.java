...
public class Mapdemo2 extends Fragment {
	View v;
...
//				params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
    ...
    public void drawOverlay(View view){
        view.postDelayed(new Runnable() {
            public void run() {
                Rect r = new Rect();
                if (null != overlay && null != overlayImage &&  Global.mapdemosteps == 1) {
                    ...
                    switch (Global.mapdemosteps){
                        case 1:{
                            View newfmymem = v.findViewById(R.id.newfmymem);
                            if(null != newfmymem && newfmymem.getGlobalVisibleRect(r)){
