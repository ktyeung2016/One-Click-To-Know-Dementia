...
public class MyDBHelper_game1 extends SQLiteOpenHelper {
	...
	private final static String DATABASE_NAME = "gameone.db";  //資料庫名稱

	private final static int DATABASE_VERSION = 1;  //資料庫版本

	public MyDBHelper_game1(Context context) {
