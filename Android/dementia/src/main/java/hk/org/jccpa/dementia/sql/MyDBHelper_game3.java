...
public class MyDBHelper_game3 extends SQLiteOpenHelper {
	...
	private final static String DATABASE_NAME = "game3jcdb.db";  //資料庫名稱

	private final static int DATABASE_VERSION = 1;  //資料庫版本

	public MyDBHelper_game3(Context context) {
