...
public class MyDBHelper_game4 extends SQLiteOpenHelper {
	...
	public static final String TABLE_NAME = "gamefourrk";  //表格名稱
	...
	private final static String DATABASE_NAME = "jcdb4.db";  //資料庫名稱

	private final static int DATABASE_VERSION = 1;  //資料庫版本

	public MyDBHelper_game4(Context context) {
