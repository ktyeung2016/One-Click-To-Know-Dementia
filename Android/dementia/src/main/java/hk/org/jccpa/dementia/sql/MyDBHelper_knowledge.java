...
public class MyDBHelper_knowledge extends SQLiteOpenHelper {
	...
	public static final String TABLE_NAME = "knowledge";  //表格名稱
	...
	private final static String DATABASE_NAME = "knowledge.db";  //資料庫名稱

	private final static int DATABASE_VERSION = 1;  //資料庫版本

	public MyDBHelper_knowledge(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		final String INIT_TABLE = "CREATE TABLE " + TABLE_NAME + " (" +_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "  +dbid + " CHER , "+redirect + " CHER , "+ title_zh + " CHER, " 
