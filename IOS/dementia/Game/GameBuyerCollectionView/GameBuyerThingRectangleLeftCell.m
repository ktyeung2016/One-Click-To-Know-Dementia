//
//  GameBuyerThingRectangleLeftCell.m
//  dementia
//
//
...
@implementation GameBuyerThingRectangleLeftCell

- (void)setUpViewWithImageNumber:(NSUInteger)imageNumber {
    [self.thingImgView setTag:imageNumber];
    
    [self.thingImgView setImage:[UIImage imageNamed:[NSString stringWithFormat:(imageNumber < 10) ? @"Game1_a00%lu" : @"Game1_a0%lu", (unsigned long)
                                                     imageNumber]]];
